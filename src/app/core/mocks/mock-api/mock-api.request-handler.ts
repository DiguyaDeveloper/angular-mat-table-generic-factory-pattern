...
import { CeccoffMockApiReplyCallback } from "./mock-api.types";

export class CeccoffMockApiHandler {
  request!: HttpRequest<any>;
  urlParams!: { [key: string]: string };

  // Private
  private _reply: CeccoffMockApiReplyCallback = undefined;
   ...
   * @param callback
   */
  reply(callback: CeccoffMockApiReplyCallback): void {
    // Store the reply
